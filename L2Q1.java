...
class ListaSequencialOrdenada {
    ...
    public ListaSequencialOrdenada(int capacidade) {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Defina a capacidade máxima da lista: ");
        int capacidade = scanner.nextInt();
        ListaSequencialOrdenada lista = new ListaSequencialOrdenada(capacidade);
